...
auth_urlpatterns = [
    ...
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', auth.reset_confirm,
...
kyc_urlpatterns = [
    url(r'^getGroupData/(?P<groupID>[^/]+)/(?P<loanId>[^/]+)/(?P<taskName>[^/]+)', kyc.getGroupData,
        name='getGroupData'),
    url(r'^getIndMemberData/(?P<memberId>[^/]+)/(?P<groupId>[^/]+)/(?P<loanId>[^/]+)/(?P<taskName>[^/]+)',
        kyc.getIndMemberData, name='getIndMemberData'),
    ...
    url(
        r'^loanAccNo/(?P<loanAccNumber>[^/]+)/(?P<appGroupId>[^/]+)/(?P<loanTypeName>[^/]+)/(?P<groupName>[^/]+)/(?P<funder>[^/]+)/(?P<successMsg>[^/]+)',
        kyc.loanAccNo, name='loanAccNo'),
    ...
    url(r'^getLoanLevelComments/(?P<processId>[^/]+)/(?P<loanId>[^/]+)', kyc.getLoanLevelComments, name='getLoanLevelComments'),
    url(r'^getLoanMemberPaymentHistory/(?P<memberId>[^/]+)/(?P<groupId>[^/]+)', kyc.getLoanMemberPaymentHistory,
        name='getLoanMemberPaymentHistory'),
    url(r'^getLoanGroupPaymentHistory/(?P<groupId>[^/]+)', kyc.getLoanGroupPaymentHistory,
        name='getLoanGroupPaymentHistory'),
...
camundaViews_urlpatterns = [
    ...
    url(r'^KYCTasksGroupByDate/(?P<dateFrom>[^/]+)/(?P<dateTo>[^/]+)', camundaViews.KYCTasksGroupByDate,
        name='KYCTasksGroupByDate'),
