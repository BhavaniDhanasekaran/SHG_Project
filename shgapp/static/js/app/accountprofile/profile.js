  ...
  $(".btn-save-picture").click(function () {
    $.ajax({
      ...
      success: function (data) {
        ...
        console.log('save_uploaded_picture - ajax success', data);
        setTimeout(function() {
          console.log('save_uploaded_picture - modal-upload-picture hide');
          $("#modal-upload-picture").modal('hide');
        }, 1000);
      }
    });
  });
