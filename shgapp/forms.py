...
from shgapp.models import CustomUser, Profile
...
class ProfileForm(forms.ModelForm):    
    ...
    personal_email = forms.CharField(widget=forms.EmailInput(attrs={ 'class': 'form-control' }), max_length=254, required=False)
    address = forms.CharField(widget=forms.TextInput(attrs={ 'class': 'form-control' }), max_length=150, required=False)
    url = forms.CharField(widget=forms.TextInput(attrs={ 'class': 'form-control' }), max_length=150, required=False)
    ...
    class Meta:
        model = Profile
        fields = ['first_name', 'last_name', 'personal_email', 'address', 'url', 'institution']
